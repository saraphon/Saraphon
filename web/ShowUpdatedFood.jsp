<%-- 
    ...
    Created on : Aug 25, 2024, 1:18:53 PM
    Author     : LENOVO
--%>
    ...
    <body>
        ...
        <form action="AddNewFoodServlet2" method="post">
            ...
            <select id="Type" name="Type">
                <option value="S" <%= newFood.getType().equals("S") ? "selected" : ""%>>S</option>
                <option value="M" <%= newFood.getType().equals("M") ? "selected" : ""%>>M</option>
                <option value="L" <%= newFood.getType().equals("Regular Fries") ? "L" : ""%>>Regular Fries</option>
                <option value="XL" <%= newFood.getType().equals("XL") ? "XL" : ""%>>Tornado Fries</option>
            </select><br>
            ...
            <input type="submit" value="Edit Fried chickens">
