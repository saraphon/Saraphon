 ...
 * @author LENOVO
 */
public class showFoodFromREST extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = "http://localhost:8080/Saraphon/getFoodDataService/" + foodname;
        ...
        if (responseCode == 200) {
            ...
            out.println("<button onclick=\"window.location.href='getFoodREST.jsp';\">Return to search page</button>");
